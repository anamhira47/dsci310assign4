...
```{r figure-1, out.width=50, out.height=50, fig.cap= "Figure 1: Horse populations for all provinces in Canada from 1906 - 1972"
} 
...
```{r figure-2, out.width=50, out.height=50, fig.cap= "Figure 2: Horse populations for the province with the largest standard deviation"}
knitr::include_graphics("../../results/horse_pop_plot_largest_sd.png")
```



In Figure 2 \@ref(fig:figure-2) we zoom in and look at the province of ?, which had the largest spread of values in terms of standard deviation.
