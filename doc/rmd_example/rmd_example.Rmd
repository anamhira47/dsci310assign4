...
Additionally, note that in Table 1 \@ref(tab:horses-sd-table). we consider the sample standard deviation of the number of horses during the same time span as Figure1.
...
In Figure 2 \@ref(fig:horse-sd-plot) we zoom in and look at the province of `r  largest_sd`, which had the largest spread of values in terms of standard deviation.
